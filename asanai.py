...
def classify_and_display(model: Any, filename: str, labels: list[str], height: int = 224, width: int = 224, divide_by: Union[int, float] = 255.0) -> None:  # pylint: disable=too-many-arguments
